...
TARGET_RECOVERY_DEVICE_DIRS := device/hmd/WSP_sprout/recovery/root
...
TARGET_PREBUILT_KERNEL := device/hmd/WSP_sprout/prebuilt/$(BOARD_KERNEL_IMAGE_NAME)
#BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/dtbo
BOARD_PREBUILT_DTBIMAGE_DIR := device/hmd/WSP_sprout/prebuilt/dtb
...
TARGET_RECOVERY_FSTAB := device/hmd/WSP_sprout/recovery.fstab
BOARD_HAS_LARGE_FILESYSTEM := true

# Vendor Interface Manifest
#DEVICE_MANIFEST_FILE := device/hmd/WSP_sprout/recovery/root/vendor/etc/vintf/manifest.xml
#DEVICE_MATRIX_FILE := device/hmd/WSP_sprout/recovery/root/vendor/etc/vintf/compatibility_matrix.xml
...
# TW Version
#TW_DEVICE_VERSION := -UPA13.20210720.V3.02 by lopestom
